...
Streamer =
{
    ...
    -- The default distance before players are streamed out.
    -- Default value (in metres): 500
    PlayerStreamDistance        = 500,

    -- The default distance before vehicles are streamed out.
    -- Default value (in metres): 500
    VehicleStreamDistance       = 500,

    -- The default distance before checkpoints are streamed out.
    -- Default value (in metres): 500
    CheckpointStreamDistance    = 500,

    -- The size of an individual cell. The default value results in a group of 
    -- 64x64 cells across Panau. Ensure this is a power of two less than or
    -- equal to 32768!
    -- Default value (in metres): 512
    CellSize                    = 512
}
...
Player =
{
    ...
    SpawnPosition               = Vector3( -6732.89892578125, 220.467559814453, -3591.05688476563 )
}
